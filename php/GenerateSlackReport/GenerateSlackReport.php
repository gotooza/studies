...
//	mb_internal_encoding("UTF-8");
	...
	// <generate html from channel logs>
		...
		foreach($channels as $channel) {
			...
			if(empty($messages)) continue;
			$htmlMessages='<meta charset="UTF-8"><html><body><style>'.$stylesheet.'</style><div class="messages">';
			foreach($messages as $message) {
	...
	// <make index html>
		$html='<meta charset="UTF-8"><html><body><style>'.$stylesheet.'</style><div class="messages">';
